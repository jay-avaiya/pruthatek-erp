...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-28">
      {/* ---- title ---- */}
      <div className="font-inter w-full max-w-6xl mx-auto text-center flex flex-col items-center gap-y-6">
        <p className="text-[#F19623] font-medium text-[16px]">
          Manage Invoices, Inventory & GST Returns, Track Payments, Send
          Reminders, and much more
        </p>
        <h3 className="text-[50px] font-black text-[#282D30] leading-[60px]">
          Comprehensive Accounting Software For Small Businesses & Growing
          Companies
        </h3>
        <p className="text-[16px] text-[#7C7C7C] leading-[32px]  w-[68%]">
        ...
        <button className="text-white bg-[#FB8C5C] text-[16px] font-bold rounded-full py-3 px-14 cursor-pointer">
          Start 7 day free trial
        </button>
      </div>

      {/* ---- home image ---- */}
      <div className="font-inter flex flex-col items-center gap-y-14 px-24 w-full max-w-6xl">
        <h3 className="text-[40px] font-semibold text-[#282828]">
      ...
      {/* ---- customer reviews ---- */}
      <div className="flex flex-col px-24 w-full gap-y-14 font-inter">
        <div>
      ...
      {/* ---- Needs of Business ---- */}
      <div className="w-full flex flex-col px-24 gap-y-14 font-inter">
        <div>
      ...
      {/* ---- PMS ---- */}
      <div className="flex flex-col px-24 gap-y-14 font-inter">
        <div>
          <p className="text-[16px] font-semibold text-[#F19623]">
            Why Pruthatek’s PMS?
          </p>
